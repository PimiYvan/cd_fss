...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, transform, split, shot):
        ...
        self.img_path = os.path.join('./Datasets_PATNET/VOCdevkit/VOC2012/JPEGImages/')
        self.ann_path = os.path.join('./Datasets_PATNET/VOCdevkit/VOC2012/SegmentationClassAug/')
    ...
    def __getitem__(self, idx):
        ...
        print(query_name, support_names)
