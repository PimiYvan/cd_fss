...
def train(epoch, model, dataloader, optimizer, training):
    ...
    for idx, batch in enumerate(dataloader):
        ...
        print(batch['query_img'].size(), batch['support_imgs'].size(), batch['support_imgs'].squeeze(1).size(), batch['support_masks'].squeeze(1).size())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='./Datasets_PATNET') # for the testing dataset 
    ...
    #     print(batch, 'test set')
    # for idx, batch in enumerate(dataloader_val):
    #     print(batch, 'train set')
    # Train HSNet
